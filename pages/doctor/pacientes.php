...
// Mostrar solo los pacientes registrados por este doctor
$query = "SELECT * FROM pacientes WHERE doctor_id = :doctor_id ORDER BY id DESC";
...
<head>
    ...
    <title>Mis Pacientes - Hospital EPS</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container-fluid mt-4">
                <div class="row mb-4">
                    <div class="col-12">
                        <h2><i class="bi bi-person-heart"></i> Mis Pacientes</h2>
                    </div>
                </div>
                
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="bi bi-list"></i> Lista de Pacientes Atendidos</span>
